...
Créér une base de données (de préférence PostgreSQL avec pgadmin4) <br/>
Créér un fichier `.env` à la racine du projet, et rentrer les informations de la base de donnée :
